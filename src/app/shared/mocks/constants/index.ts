...
export const TaskFlipMock = ConstantMocks.getTaskMock('mocked task 3', [
  VoteFlipMock,
])
export const RoomEmptyMock = ConstantMocks.getRoomMock(
  'mocked room',
  'mocked creator'
)
...
export const RoomTaskAndVotesMock = ConstantMocks.getRoomMock(
  'mocked room',
  'mocked creator',
  [TaskMock],
  'mocked id'
